...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='Jhon', password='1234')
        self.usuario_b = User.objects.create(username='Salo', password='1234')
        self.usuario_c = User.objects.create(username='Nico', password='1234')
