...
from .models import AvailableAppointment
import os.path
...
def form(request):
    appointments = AvailableAppointment.objects.filter(available=True)
    ...
    return render(request, 'fill_appointment.html', {'form': form, 'appointments': appointments})
